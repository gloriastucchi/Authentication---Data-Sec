...
public class PermissionChecker {
    ...
    public static boolean canExecuteFunction(String username, String functionName, String filePath) {
    ...
    public static void main(String[] args) {
        String filePath = "path/to/your/permissions.csv";
        boolean hasPermission = canExecuteFunction("exampleUser", "exampleFunction", filePath);
